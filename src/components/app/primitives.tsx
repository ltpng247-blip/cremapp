...
const STATUS_MAP: Record<string, { label: string; variant: any }> = {
  ...
  ENDORSED_SECTION_HEAD: { label: "Awaiting Registrar", variant: "warning" },
  VERIFIED: { label: "Awaiting approval", variant: "warning" },
  APPROVED: { label: "Approved", variant: "success" },
  COMMITTED: { label: "Approved & committed", variant: "success" },
